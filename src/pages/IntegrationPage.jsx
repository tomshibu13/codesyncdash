...
export default function IntegrationPage() {
  ...
  return (
    ...
    >
      ...
      <div className={`p-8 rounded-3xl border transition-all duration-300 max-w-2xl ${
        isDarkMode ? 'bg-slate-900/80 border-slate-800/80 shadow-2xl' : 'bg-white border-slate-200 shadow-xl'
      }`}>
          ...
          <div className={`p-5 rounded-2xl border ${isDarkMode ? 'bg-[#0D0D0D] border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
             ...
             <div className="flex items-center gap-4">
               <button
                ...
                className={`flex items-center gap-2 px-6 py-3 text-sm font-bold rounded-xl shadow-lg transition-all duration-200 ${
                  integrationData?.integrationComplete
          ...
          <div className={`p-5 rounded-2xl border ${isDarkMode ? 'bg-[#0D0D0D] border-slate-700' : 'bg-slate-50 border-slate-200'}`}>
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-3 py-3 border rounded-xl text-sm transition-colors focus:ring-2 focus:ring-emerald-500 focus:outline-none ${
                  isDarkMode 
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                disabled={integrationData?.hostingComplete}
                className={`flex items-center gap-2 px-6 py-3 text-sm font-bold rounded-xl shadow-lg transition-all duration-200 ${
                  integrationData?.hostingComplete
